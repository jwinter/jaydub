...
{
  [context evaluateScript:[NSString stringWithFormat:@"goog.require('%@');", [self munge:@"jaydub.core"]]];
}
...
- (void)contentDidAppear
{
  ...
  JSValue* initFn = [self getValue:@"init" inNamespace:@"jaydub.core" fromContext:context];
